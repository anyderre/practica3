               ...
               <div class="col-md-offset-2 col-md-9">
                ...
                <div class="row">
                    ...
                    <#if comentarios?size!=0>
                        <#list comentarios as comentario>
                            <div>
                                <p style="border:1px solid lavender;">${comentario}</p>
                            </div>
                ...
                <form method="post" action="/agregar/comentario/${articulo.getId()}">
                 <div class="row">
                    ...
                    <div class="row">
                     <div class="col-md-offset-2 col-md-8">
                         <button class="btn btn-lg btn-primary btn-block btn-signin form-control" id="IngresoLog" type="submit" style="margin-bottom: 15px">Agregar</button>
                     </div>
                 </div>          
             </form>
